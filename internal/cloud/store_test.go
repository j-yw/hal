...
func (m *mockStore) UpdateAttemptSandboxID(_ context.Context, _, _ string) error { return nil }
...
func (m *mockStore) GetActiveAttemptByRun(_ context.Context, _ string) (*Attempt, error) {
	return nil, nil
}
