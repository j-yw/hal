...
// runLoopStep executes the Ralph loop to complete all tasks in the PRD.
...
func buildPRBody(state *PipelineState) string {
	...
	sb.WriteString("---\n\n")
	sb.WriteString("🤖 Generated by [goralph](https://github.com/jywlabs/goralph) compound pipeline\n")
