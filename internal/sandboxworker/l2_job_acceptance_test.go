...
func TestL2JobProtocolOperationsAreAcceptedByVersionedEnvelope(t *testing.T) {
	...
	requests := []string{
		`{"protocolVersion":"sandboxworker-v1","requestId":"req-start","operation":"job_start","driverId":"rootless_podman","jobStart":{"contractVersion":"sandboxjob-v1","submissionId":"submission-1","exec":{"operationId":"op-1","target":{"name":"box","runtime":{"driver":"rootless_podman","runtimeId":"runtime-1"}},"args":["true"],"stdoutLimitBytes":1024,"stderrLimitBytes":1024}}}`,
