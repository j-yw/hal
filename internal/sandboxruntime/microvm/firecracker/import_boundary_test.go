...
func TestFirecrackerPackageDeclaresExpectedFoundationExports(t *testing.T) {
	...
	allowedExportedNames := map[string]bool{
		...
		"L8LiveBootConfigOverlay":               true,
		"L8LiveBootConfigProvider":              true,
		"L8LiveBootConfigRequest":               true,
		...
		"SanitizeGuestReadinessRequest":         true,
		"SanitizeGuestReadinessResult":          true,
