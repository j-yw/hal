...
func TestL4ServerStrictRequestFailuresNeverReachBackend(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "base64 embedded newline", body: []byte(`{"protocolVersion":"guest-agent-v1","operation":"exec","args":["tool"],"workDir":"/workspace","stdin":{"sizeBytes":1,"maxBytes":16,"encoding":"base64","data":"Z\nA=="},"stdout":{"maxBytes":16},"stderr":{"maxBytes":16}}`), code: guestagent.ErrorCodeInvalidMetadata},
		{name: "base64 nonzero padding bits", body: []byte(`{"protocolVersion":"guest-agent-v1","operation":"exec","args":["tool"],"workDir":"/workspace","stdin":{"sizeBytes":1,"maxBytes":16,"encoding":"base64","data":"ZE=="},"stdout":{"maxBytes":16},"stderr":{"maxBytes":16}}`), code: guestagent.ErrorCodeInvalidMetadata},
