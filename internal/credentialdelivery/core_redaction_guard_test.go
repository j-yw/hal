			...
			payload := struct {
				...
				Plan: SanitizePlanMetadata(Plan{
					...
					SSHAgentProof: &SSHAgentProof{
						...
						SecretID:              unsafeValue,
						SecretBrokerSessionID: unsafeValue,
						DeliveryPlanID:        unsafeValue,
						DeliverySessionID:     unsafeValue,
						DeliveryBindingID:     unsafeValue,
						HandoffID:             unsafeValue,
						HandoffStatus:         Status(unsafeValue),
						HandoffReasonCode:     ReasonCode(unsafeValue),
						CapabilityID:          unsafeValue,
						CapabilityMode:        Mode(unsafeValue),
						CapabilityStatus:      Status(unsafeValue),
