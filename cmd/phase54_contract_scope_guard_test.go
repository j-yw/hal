	...
	cases := []struct {
		...
		},
		{
			...
			want: []string{
				...
				"workerRouting,omitempty", "templateLock,omitempty", "artifacts,omitempty", "artifactMetadata,omitempty",
		...
		},
		{
			...
			want:  []string{"contractVersion", "version", "runId", "status", "nextAction", "artifacts", "telemetry,omitempty", "eventSummary", "failure"},
		},
		{
