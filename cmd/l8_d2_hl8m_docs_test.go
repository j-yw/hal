...
func TestL8D2HL8MControllerMonitorABIIsImplementationReady(t *testing.T) {
	...
	for _, required := range []string{
		...
		"ControllerMonitorPrepareFileSlot",
		"InspectControllerMonitorPrepareFileSlot",
		"ControllerMonitorPrepareFileObservation",
		"AcceptPrepareFile",
		"rejects `0x11` before generic body decoding",
		"generic packet encoder and decoder both reject `0x11`",
		"packet union\ncontains no private file-body owner",
		"diagnostic exception is forbidden",
