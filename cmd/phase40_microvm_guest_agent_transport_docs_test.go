...
func TestPhase40MicroVMGuestAgentTransportVerificationDocs(t *testing.T) {
	...
	required := []string{
		...
		"Copy-in sends only the guest destination path.",
		"Copy-out sends only the guest source path.",
...
func phase40RequiredFocusedTests() []phase34FocusedTest {
	return []phase34FocusedTest{
		...
		{pkg: "./internal/sandboxruntime/microvm/firecrackerhost", file: filepath.Join("..", "internal", "sandboxruntime", "microvm", "firecrackerhost", "guest_transport_test.go"), testName: "TestGuestAgentTransportCopyInDelegatesGuestDestinationOnly"},
		{pkg: "./internal/sandboxruntime/microvm/firecrackerhost", file: filepath.Join("..", "internal", "sandboxruntime", "microvm", "firecrackerhost", "guest_transport_test.go"), testName: "TestGuestAgentTransportCopyOutDelegatesGuestSourceOnly"},
