...
func TestL8D4SyscallAdapterFoundationIsTruthfullyDocumented(t *testing.T) {
	...
	for _, marker := range []string{
		...
		"one bounded regular file through a no-follow descriptor",
		"code-review tripwire",
		"coordinated wrapper-and-lock update requires explicit code review and protected branch enforcement",
